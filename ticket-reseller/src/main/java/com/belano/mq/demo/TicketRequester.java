...
/**
 * A <code>TicketRequester</code> uses peer to peer messaging to put and get messages to and from a queue.
 */
public class TicketRequester {
  ...
  /**
   * Constructs a TicketRequester with the Session representing the connection to MQ.
   *
  ...
  /**
   * puts a message on the purchase queue, by merging the number of tickets desired with the message recieved from the
   * subscription into a new Request.
   * <p>
