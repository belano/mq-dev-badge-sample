...
/**
 * The purpose of this application is to demonstrate how MQ can be used in a ticket seller scenario. Using connections
 * to queues and topics to send/receive messages to/from.
 *
...
public class Manager {
   ...
   * of {@link com.belano.mq.badge.StorageManager}, {@link com.belano.mq.badge.EventManager} and {@link
   * com.belano.mq.badge.Cashier} resides.
   *
  ...
  /**
   * Logging is initialised here with console and file writing handlers. The handlers added are: <>ul>
   * <li>Console handler
   * <li>File handler
   * <li>Severe handler
   * </ul>
    ...
    Formatter format = new SimpleFormatter() {
      ...
      public synchronized String format(LogRecord lr) {
        ...
        return String.format(FORMAT,
            ...
            Thread.currentThread().getStackTrace()[stackTraceElement].getClassName().toString()
                .replace("com.belano.mq.badge.", ""),
