...
/**
 * Deals with connections to MQ. This class is responsible for the config and creation of connections to topics or
 * queues. The default file requested by this class must obey the following:
 * <ul>
...
public class EnvSetter {
  ...
  /**
   * The JSON object that holds information from an <tt>mqConfig</tt> file used to set the configuration for the MQ
   * connection.
   */
  ...
  /**
   * A list of all open connections created by this instance of {@link EnvSetter}
   */
  ...
  /**
   * Creates the {@link EnvSetter} with a file that provides details for the MQ connection in the format of
   * <b>JSON</b>.
   *
   * @param filename The filename which contains all the details for the MQ connections.
   */
  ...
  /**
   * Creates a base {@link EnvSetter} which with no filename set, will create an MQ connection using the default details
   * provided in the source code. These details will be wrong so providing a file with connection configuration is the
   * way to go.
   */
  public EnvSetter() {
  }
  ...
  /**
   * Creates a MQ session with the details provided for this class. The session created will be returned meaning that
   * classes that will be using queues and topics, for message transfer, can use this class to create their
   * connections.
   *
   * @return A JMSContext that can be used in sending and receiving messages from queues or topics.
   */
  ...
  /**
   * Closes all the open connections that were created by this instance of {@link EnvSetter}.
   */
  ...
  /**
   * Sets the properties of the ConnectionFactory from default details or the details provided.
   *
  ...
  /**
   * Overrides the default values for the connection to the values found in the file provided.
   */
  private void setMQVariables() {
    if (mqEnv != null) {
      try {
        this.HOST = getEnvKey("HOST");
        this.PORT = Integer.parseInt(getEnvKey("PORT"));
   ...
   * @throws JSONException Thrown when a key could not be retrieved from the JSON Object {@code mqEnv}.
   */
